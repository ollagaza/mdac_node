...
export default class StatisticsModel extends MySQLModel {
  ...
  getStatistics = async (search_seq, project_seq, search_type, start_date, end_date) => {
    const result = {}
    ...
    // console.log(select)
    const oKnex = this.database.raw(select, [search_seq,project_seq,search_type,start_date,end_date])
